...
public class QuestionsTest extends BaseTest {
    ...
    public QuestionsTest(int numberAnswer, String answer) {
    ...
    public void checkAnswerText() {
        ...
        accordionItems.get(numberAnswer).click();

        String actualAnswer = accordionItems.get(numberAnswer).findElement(By.className("accordion__panel")).getText();
        assertEquals("Не правильный текст", answer, actualAnswer);
    }
}
